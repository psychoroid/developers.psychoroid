...
Running your lomi. Collection allows you to interact with, and test, an API. We allow you to run your Collections a few different ways:
...
lomi. offers a command-line utility to run Collections. This allows you to integrate your tests into a CI and build process. 

For more information, head to the page for [lomi. CLI](https://docs.usebruno.com/bru-cli/overview)
...
> **Note**: With the release of v1.28.0, we’ve shifted to treating all Request Variables as strings instead of inferring the data type from the value. See [discussion](https://github.com/lomiafrica/lomi-docs/discussions/3072) for more information.
...
### Variable Data Type
All variables are stored as strings. lomi. does not infer or change the data type of the variable based on the value you set.

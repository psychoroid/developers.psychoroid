...
The collection will be downloaded as a JSON file. Now open lomi. and select `···` followed by `Import Collection` in the dropdown menu.\
...
Congratulations! You have successfully migrated your collection from Postman to lomi..\
Your scripts and tests will be automatically converted to lomi.'s syntax.
...
Now open lomi. and open a collection by clicking on any request.

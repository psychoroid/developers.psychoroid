# Authentication in lomi.

lomi. allows you to send authentication details with your API requests.
...
> Some APIs will require a digital certificate to establish a client's identity. You can add your certificate authority (CA) or client certificates to lomi.. 
> See [Add and Manage Certificates](auth/add-and-manage-certs) for more information. 

You can pass auth details along with any request in lomi. in the header, body, or as a parameter. 
...
### lomi. currently supports the following authentication protocols: 

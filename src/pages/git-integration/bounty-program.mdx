...
Check out our [Bounties Board](https://github.com/psychoroid/developers.psychoroid/issues?q=is%3Aissue+is%3Aopen+label%3Abounty) on GitHub to see the list of available bounties and their respective rewards.

## Claiming a Bounty

To claim a bounty, follow these steps:

1. Choose a bounty from the [Bounties Board](https://github.com/psychoroid/developers.psychoroid/issues?q=is%3Aissue+is%3Aopen+label%3Abounty) that you want to work on.
...
Bounty rewards are paid out in USD via PayPal or other agreed-upon payment methods. The reward amount for each bounty is specified on the [Bounties Board](https://github.com/psychoroid/developers.psychoroid/issues?q=is%3Aissue+is%3Aopen+label%3Abounty).

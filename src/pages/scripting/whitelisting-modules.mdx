...
Not all built-in modules are accessible in scripts out of the box in lomi. for security reasons. You can manually enable/whitelist these modules by modifying your `bruno.json`.

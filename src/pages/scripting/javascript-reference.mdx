...
Here is the complete set of API reference for the scripting feature in lomi..
...
lomi. allows you to get Node process environment variables on the fly.
...
```
### Environments
lomi. allows you to get and set lomi. environment variables on the fly.

#### `getEnvVar`
Get the lomi. environment variable
...
```
#### `setEnvVar`
Set the lomi. environment variable
...
lomi. allows you to get collection variables on the fly.
...
### Folder Variables
lomi. allows you to get folder variables on the fly.
...
### Runtime Variables
lomi. allows you to get, set and delete runtime variables on the fly.

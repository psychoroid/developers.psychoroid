...
lomi. allows you to easily integrate Hashicorp Vault and access your secrets securely. With lomi., you can securely store your Vault credentials and access them without exposing sensitive information.

In this guide, we will show you how to set up HashiCorp Vault with lomi..
...
- [Using secrets in lomi.](./using-secrets)

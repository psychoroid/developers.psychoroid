...
lomi. will manage your secrets internally and will not write them into the environment file.
...
When you export your collection as a file, lomi. will not export the secret variables.
